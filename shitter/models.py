...
class Shit(models.Model):
    text = models.CharField(default='', max_length=280, blank=True, verbose_name=_('text'))
    ...
    reshit = models.ForeignKey('shitter.Shit', on_delete=models.CASCADE, verbose_name=_('reshit'), null=True)
